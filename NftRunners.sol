...
contract NftRunners is ERC721, ERC721URIStorage, VRFConsumerBaseV2 {
    ...
    struct Runner {
        ...
        string image;
        uint256 distance; //distancia que recorre mi personaje 

    }

    Runner[] public runners; //Lista de NFTs corredores, empezando con 0 es una cadena de carácteres
    ...
    function safeMint(address to, uint256 charId) public {
        ...
        string memory uri = Base64.encode( //Creamos la metada de nuestro NFT dentro del smart contract, usamos la librería String de openzeppelin
